...
import { add_giftee, remove_giftee } from 'Xmas/Store/Actions';
    ...
    <ul>
        ...
        </form></li>
        {
            this.props.giftees.map( g => 
                <li><Link to={ '/giftee/' + g.name }>{ g.name }</Link>
...
export default connect( undefined, { add_giftee, remove_giftee })( ListOfPeeps );
